...
def main():
    ...
    # HR images
    opt['input_folder'] = 'datasets/BSD300/GTmod12'
    opt['save_folder'] = 'datasets/BSD300/GTmod12_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx2 images
    opt['input_folder'] = 'datasets/BSD300/LRbicx2'
    opt['save_folder'] = 'datasets/BSD300/LRbicx2_sub'
    opt['crop_size'] = 240
    opt['step'] = 120
    opt['thresh_size'] = 0
    extract_subimages(opt)
